...
// Testing strategy
    ...
    public void testSampleTests() throws IOException {
        final GraphPoet nimoy = new GraphPoet(new File("src/test/java/com/awei/P1/poet/mugar-omni-theater.txt"));
    ...
    public void testOnlineSamples() throws IOException{
        final GraphPoet graphPoet = new GraphPoet(new File("src/test/java/com/awei/P1/poet/seven-words.txt"));
...
//        System.out.println(output);
    ...
    public void testEmptyFileEmptyString() throws IOException{
        final GraphPoet graphPoet = new GraphPoet(new File("src/test/java/com/awei/P1/poet/empty.txt"));
        final String input = "";
...
//        assertThat(output, containsString("eleven"));
    ...
    public void testOneLineGraphOneWord() throws IOException{
        final GraphPoet graphPoet = new GraphPoet(new File("src/test/java/com/awei/P1/poet/one-line-graph.txt"));
        final String input = "one";
        assertEquals(input, graphPoet.poem(input));
    }
    ...
    public void testRealPoem() throws IOException{
        ...
        final GraphPoet graphPoet = new GraphPoet(new File("src/test/java/com/awei/P1/poet/Desiderata.txt"));
